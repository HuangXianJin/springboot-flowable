...
public enum ErrorCode {
    ...
    SMS_CODE_ERROR(3006, "sms_code_error"),
    MINIAPP_LOGIN_ERROR(3007, "miniapp_lgoin_error"),
    IMG_VERIFICATION_CODE_ERROR(3008, "img_verification_code_error"),
    PASSWORD_TIMES_ERROR(3009,"password_times_error"),
    LOGIN_TYPE_NOT_SUPPORT(30010, "login_type_not_support"),
    /**
     * 请求错误
     */
