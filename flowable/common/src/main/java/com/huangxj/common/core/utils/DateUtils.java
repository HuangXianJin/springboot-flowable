...
public class DateUtils extends org.apache.commons.lang3.time.DateUtils {
    ...
    public static String formatTextFromDeadline(Date date) {
        ...
        if (remain <= ONE_HOUR) {
            ...
            return "还有" + day + "天" + hour + "小时" + minute + "分钟";
        }
    ...
    public static long getMin(Date start, Date end) {
        long m = (end.getTime() - start.getTime()) / (ONE_MILLIS * ONE_MINUTE);
        return m;
    }
...
//        System.out.println(formatDate(getAfterYear(new Date()), "yyyy-MM-dd"));
     ...
     * @return
     */
    public static Long getTimeMillisecond(Date dateTime) {
        String timeString=DateUtils.formatDate(dateTime, "HH:mm:ss");
     ...
     * @return
     */
    public static Long getTimeMillisecond(Long dateTime) {
        return DateUtils.getTimeMillisecond(new Date(dateTime));
    }
     ...
     * @return
     */
    public static Long getDateMillisecond(Date dateTime) {
        String dayString=DateUtils.formatDate(dateTime, "yyyy-MM-dd");
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
        try {
            return sdf.parse(dayString).getTime();
        } catch (ParseException e) {
            return null;
        }
    }

    public static Long getDateMillisecond(Long dateTime) {
        return DateUtils.getDateMillisecond(new Date(dateTime));
    }
    ...
    public static Date getDate(Long dateTime) {
        String dayString=DateUtils.formatDate(new Date(dateTime), "yyyy-MM-dd");
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
        try {
    ...
    public static String transDuration(Long duration){
        long sec =  (int) ((duration % (1000 * 60 )) / 1000 );
        int minute = (int) ((duration % (1000 * 60 * 60)) / (1000 * 60));
        //int hour = (int) ((duration % (1000 * 60 * 60 * 24)) / (1000 * 60 * 60));
